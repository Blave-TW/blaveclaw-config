...
- **Ask one question first when the symbol does not exist or you are unsure of it, the date is in the future, or the user names a report kind that has no template** (a 收盤報告 — never publish it under a template's id): `references/reports.md` §1b.
